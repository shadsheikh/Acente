...
class BireyselRequestSuccessful extends StatefulWidget {
  static const String routname = '/bireysel_request_successful';

  @override
  _BireyselRequestSuccessfulState createState() =>
      _BireyselRequestSuccessfulState();
}

class _BireyselRequestSuccessfulState extends State<BireyselRequestSuccessful> {
  int count = 0;
