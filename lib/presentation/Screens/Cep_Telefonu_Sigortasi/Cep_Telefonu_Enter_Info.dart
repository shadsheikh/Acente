...
class CepTelefonuEnterInfo extends StatefulWidget {
  static const String routname = '/cep_telefonu_enter_info';

  @override
  _CepTelefonuEnterInfoState createState() => _CepTelefonuEnterInfoState();
}

class _CepTelefonuEnterInfoState extends State<CepTelefonuEnterInfo> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Spacer(),
                  Text('Cep Tel. Sigortası', style: V28R),
                ],
              ),
              SizedBox(height: 40),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            SolidButton(
                              text: 'DEVAM ET',
                              onPress: () {
                                Navigator.of(context).pushNamed(CepTelefonuRequestSuccessful.routname);
                              },
                              shadow: Low_Shadow,
                              gradient: Blue_Gradient_2,
                            ),
