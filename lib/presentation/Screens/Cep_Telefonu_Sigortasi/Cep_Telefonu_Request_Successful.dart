...
class CepTelefonuRequestSuccessful extends StatefulWidget {
  static const String routname = '/cep_telefonu_request_successful';

  @override
  _CepTelefonuRequestSuccessfulState createState() => _CepTelefonuRequestSuccessfulState();
}

class _CepTelefonuRequestSuccessfulState extends State<CepTelefonuRequestSuccessful> {
  int count = 0;
