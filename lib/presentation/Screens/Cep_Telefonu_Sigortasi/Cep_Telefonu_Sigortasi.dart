...
class CepTelefonuSigortasi extends StatefulWidget {
  static const String routname = '/cep_telefonu_sigortasi';

  @override
  _CepTelefonuSigortasiState createState() => _CepTelefonuSigortasiState();
}

class _CepTelefonuSigortasiState extends State<CepTelefonuSigortasi> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage(
                  'lib/presentation/Assets/Assets_Cep_Telefonu_Sigortasi/backgroundImage.png'),
              fit: BoxFit.fill),
        ),
        child: SafeArea(
          bottom: false,
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Image.asset('lib/presentation/Assets/Assets_Teklif_AI/cep_telefon_sigortasi.png',
                        width: 48),
                    SizedBox(width: 20),
                    Text('Cep Telefonu Sigortası ', style: V28R),
                  ],
                ),
              ),
              SizedBox(height: 35),
