...
class DaskRequestSuccessful extends StatefulWidget {
  static const String routname = '/dask_request_successful';

  @override
  _DaskRequestSuccessfulState createState() => _DaskRequestSuccessfulState();
}

class _DaskRequestSuccessfulState extends State<DaskRequestSuccessful> {
  int count = 0;
          ...
          child: Column(
            ...
            children: [
              ...
              SolidButton(
                text: 'Anasayfaya Dön',
                onPress: () {
                  Navigator.of(context).pushNamed(DaskPaymentProcess.routname);
                },
                shadow: Low_Shadow,
