...
class DaskSigortasi extends StatefulWidget {
  static const String routname = '/dask_sigortasi';

  @override
  _DaskSigortasiState createState() => _DaskSigortasiState();
}

class _DaskSigortasiState extends State<DaskSigortasi> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage(
                  'lib/presentation/Assets/Assets_Dask_Sigortasi/backgroundImage.png'),
              fit: BoxFit.fill),
        ),
        child: SafeArea(
          bottom: false,
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Image.asset('lib/presentation/Assets/Assets_Teklif_AI/dask.png',
                        width: 48),
                    SizedBox(width: 20),
                    ...
                    child: Column(
                      children: [
                        ...
                        TabBar(
                          ...
                          labelColor: Blue,
                          tabs: [
                            Tab(text: 'Yeni Poliçe'),
                            Tab(text: 'Mevcut Poliçe'),
                          ],
                        ),
                        Expanded(
                          child: Stack(
