...
class DaskViewOffers extends StatefulWidget {
  static const String routname = '/dask_view_offers';
  @override
  _DaskViewOffersState createState() => _DaskViewOffersState();
}

class _DaskViewOffersState extends State<DaskViewOffers> {
                  ...
                  children: [
                    ...
                    ViewOffersItem(
                      ...
                      onButtonTap: () {Navigator.of(context)
                                    .pushNamed(DaskRequestSuccessful.routname);},
                      onChange: (val) {
                        setState(() {
                          switchValue = val;
                        });
