...
class EvcilHayvanRequestSuccessful extends StatefulWidget {
  static const String routname = '/evcil_hayvan_request_successful';

  @override
  _EvcilHayvanRequestSuccessfulState createState() => _EvcilHayvanRequestSuccessfulState();
}

class _EvcilHayvanRequestSuccessfulState extends State<EvcilHayvanRequestSuccessful> {
  int count = 0;
