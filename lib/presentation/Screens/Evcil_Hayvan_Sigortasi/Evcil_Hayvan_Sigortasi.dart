...
class EvcilHayvanSigortasi extends StatefulWidget {
  static const String routname = '/evcil_hayvan_sigortasi';

  @override
  _EvcilHayvanSigortasiState createState() => _EvcilHayvanSigortasiState();
}

class _EvcilHayvanSigortasiState extends State<EvcilHayvanSigortasi> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
              image: AssetImage(
                  'lib/presentation/Assets/Assets_Evcil_Hayvan_Sigortasi/backgroundImage.png'),
              fit: BoxFit.fill),
        ),
        child: SafeArea(
          bottom: false,
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Image.asset('lib/presentation/Assets/Assets_Teklif_AI/evcil_hayvan_sig.png',
                        width: 48),
                    SizedBox(width: 20),
