...
class KaskoRequestSuccessful extends StatefulWidget {
  static const String routname = '/kasko_request_successful';

  @override
  _KaskoRequestSuccessfulState createState() => _KaskoRequestSuccessfulState();
}

class _KaskoRequestSuccessfulState extends State<KaskoRequestSuccessful> {
  int count = 0;
