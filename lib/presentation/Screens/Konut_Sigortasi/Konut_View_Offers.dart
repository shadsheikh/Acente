...
class KonutViewOffers extends StatefulWidget {
  static const String routname = '/konut_view_offers';
  @override
  _KonutViewOffersState createState() => _KonutViewOffersState();
}

class _KonutViewOffersState extends State<KonutViewOffers> {
