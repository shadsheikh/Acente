...
class TrafikViewOffers extends StatefulWidget {
  static const String routname = '/trafik_view_offers';
  @override
  _TrafikViewOffersState createState() => _TrafikViewOffersState();
}

class _TrafikViewOffersState extends State<TrafikViewOffers> {
